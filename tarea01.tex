...
% Extra 2
%
\textbf{1.} Demuestra que para toda $b\in \N$, el número $(10101)_b$ es divisible por $(111)_b$.\\

Demostraremos existe un $k \in N$, tal que $(10101)_b = k * (111)_b$
Como son enteros de base $b$ entonces podemos reescribirlos como $n = b^k a_k + · · · + b^1 a_1 + b^0 a_0$
Notemos entonces que la longitud de $(10101)_b$ es mayor que la de $(111)_b$, por lo que \\
$(10101)_b = 1⋅b^4 + 0⋅b^3 + 1⋅b^2 + 0⋅b^1 + 1⋅b^0$
$(111)_b = 1⋅b^2 + 1⋅b^1 + 1⋅b^0$
Luego de lo anterior podemos decir que $(10101)_b > (111)_b$, notemos tambien que por definicion de la base el exponente maximo de $(111)_b$ es $2$ y el de $(10101)_b$ es $4$.
De lo anterior podemos aplicar una division polinomica de $1⋅b^4 + 0⋅b^3 + 1⋅b^2 + 0⋅b^1 + 1⋅b^0 / 1⋅b^2 + 1⋅b^1 + 1⋅b^0$\\
Dividimos el termino de grado mayor\\
$b^4 / b^2 = b^2$\\
Multiplicamos por la expresion del divisor\\
$b^2 (b^2 + b + 1) = b^4 + b^3 + b^2$\\
Restamos al polinomio que estamos dividiendo\\
$(b^4 + 0b^3 + b^2 + 0b + 1) - (b^4 + b^3 + b^2) = -b^3 + 0b + 1$\\
Volvemos a dividir el numero de grado mayor $-b^3 + 0b + 1$\\
$-b^3 / b^2 = -b$
Multiplicamos nuevamente por la expresion original\\
$−b (b^2+b+1) = −b^3 − b^2 − b$\\
Una vez mas restamos al polinomio que vamos a dividir \\
$(-b^3 + 0b + 1) - (-b^3 - b^2 - b) = b^2 + b + 1$\\
dado que todavia no es igual a 1 por el algoritmo de multiplicacion dividimos una vez mas\\
$b^2 / b^2 = 1$\\
Multiplicando una vez mas por el divisor\\
$1(b^2 + b + 1) = b^2 + b + 1$\\
Restamos una vez mas al polinomio a dividir\\
 $(b^2 + b + 1) - (b^2 + b + 1) = 0$\\
Juntando todos los divisores de exponente maximo tenemos\\
$b^2 - b + 1$\\
De la existencia anterior podemos afirmar que $(10101)_b = (b^2−b+1) (111)_b$\\
Concluyendo asi que $(10101)_b$ es divisible por $(111)_b$\\
\vspace{1cm}
